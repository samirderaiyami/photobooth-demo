...
//protocol adjustFontSizeToFillRectProtocol1 {
//    
//    func adjustFontSizeToFillRect1(_ newBounds: CGRect, view: JLStickerImgView, labelView: JLAttributedTextView) -> Void
//    func adjustsWidthToFillItsContens1(_ view: JLStickerLabelView, labelView: JLAttributedTextView) -> Void
//    
//}
//
//extension adjustFontSizeToFillRectProtocol1 {
//    func adjustFontSizeToFillRect(_ newBounds: CGRect, view: JLStickerImgView, labelView: JLAttributedTextView) {
//        var mid: CGFloat = 0.0
//        var stickerMaximumFontSize: CGFloat = 200.0
//        var stickerMinimumFontSize: CGFloat = 15.0
//        var difference: CGFloat = 0.0
